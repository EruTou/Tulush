# Задание 4
# - Реализуйте класс Deque - двустороннюю очередь или колоду. Идея та же, что и у очереди, только можно вставлять элементы в центр массива, убирать как слева, так и справа.
# - Переопределите метод __str__
# - Реализуйте методы, которые позволят вставлять элементы слева, справа, в в центр массива и аналогично удалять. 
# Решение:
